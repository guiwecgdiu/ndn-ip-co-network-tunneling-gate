...
*/
  ...
  ndn::AppHelper gatewayHelper("GatewayApp");
  //gatewayHelper.SetAttribute("GttTable",g);
  auto installedApp1=gatewayHelper.Install(iGate1);
  //ns3::Ptr<ns3::GatewayApp> gate1App=installedApp1.Get(0);
  //gate1App->Gtt_addRoute(ndn::Name("/igate1"),"10.1.5.2");

  ndn::AppHelper gatewayHelper1("GatewayApp"); 
  auto installedApp2=gatewayHelper1.Install(iGate2);
  //ns3::Ptr<ns3::GatewayApp> gate2App=installedApp2.Get(0);
  //gate2App->Gtt_addRoute(ndn::Name("/igate2"),"10.1.5.1");
...
/*
 ...
 //don't sent before 1 s second, i use this for gateway to send the election message
  ...
  consumerHelper2.SetAttribute("Batches", StringValue("3s 1000"));
  consumerHelper2.SetAttribute("LifeTime",StringValue("5s"));
  consumerHelper2.SetPrefix("/domain2/dst2");
  consumerHelper2.Install(node1);
  ...
  LogComponentEnable ("GatewayApp", LOG_LEVEL_INFO);
  ...
  //tracer
  ndn::AppDelayTracer::Install(node1,"app-delays-trace.txt"); 
  ndn::L3RateTracer::Install(node1,"l3-rate-trace.txt", Seconds(1.0)); 
  ndn::CsTracer::Install(node1,"cs-trace.txt", Seconds(1)); 
  ndn::AppDelayTracer::Install(node2,"app-delays-trace.txt"); 
  ndn::L3RateTracer::Install(node2,"l3-rate-trace.txt", Seconds(1.0)); 
  ndn::CsTracer::Install(node2,"cs-trace.txt", Seconds(1)); 
  ndn::AppDelayTracer::Install(node3,"app-delays-trace.txt"); 
  ndn::L3RateTracer::Install(node3,"l3-rate-trace.txt", Seconds(1.0)); 
  ndn::CsTracer::Install(node3,"cs-trace.txt", Seconds(1)); 
   ndn::AppDelayTracer::Install(node4,"app-delays-trace.txt"); 
  ndn::L3RateTracer::Install(node4,"l3-rate-trace.txt", Seconds(1.0)); 
  ndn::CsTracer::Install(node4,"cs-trace.txt", Seconds(1)); 
   ndn::AppDelayTracer::Install(node5,"app-delays-trace.txt"); 
  ndn::L3RateTracer::Install(node5,"l3-rate-trace.txt", Seconds(1.0)); 
  ndn::CsTracer::Install(node5,"cs-trace.txt", Seconds(1)); 
  ndn::AppDelayTracer::Install(iGate1,"app-delays-trace.txt"); 
  ndn::L3RateTracer::Install(iGate1,"l3-rate-trace.txt", Seconds(1.0)); 
  ndn::CsTracer::Install(iGate1,"cs-trace.txt", Seconds(1)); 
  ndn::AppDelayTracer::Install(iGate2,"app-delays-trace.txt"); 
  ndn::L3RateTracer::Install(iGate2,"l3-rate-trace.txt", Seconds(1.0)); 
  ndn::CsTracer::Install(iGate2,"cs-trace.txt", Seconds(1)); 
  L2RateTracer::InstallAll("l2-drop-trace.txt", Seconds(1.0));
  //tracer
