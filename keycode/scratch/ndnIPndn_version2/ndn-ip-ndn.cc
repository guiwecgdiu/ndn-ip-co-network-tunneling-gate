...
main(int argc, char* argv[])
{
  ...
  producerHelper.SetPrefix("/iGate2");
  ...
  ndn::FibHelper::AddRoute(iGate2, "/dst3", node5, 20);
  ndn::FibHelper::AddRoute(iGate2, "/dst1", node3, 20);
  ndn::FibHelper::AddRoute(iGate2,"dst2",node3,20);
  ndn::FibHelper::AddRoute(node3, "/iGate2", iGate2, 20);
  ndn::FibHelper::AddRoute(node3, "/dst2", node4, 20);
  ndn::FibHelper::AddRoute(node3, "/dst3", iGate2, 20);
  ndn::FibHelper::AddRoute(node4, "/dst1", node3, 20);
  ndn::FibHelper::AddRoute(node4, "/dst3", node5, 20);
  ndn::FibHelper::AddRoute(node4, "/iGate2", node3, 20);
  ndn::FibHelper::AddRoute(node5, "/dst2", node4, 20);
  ndn::FibHelper::AddRoute(node5, "/iGate2", iGate2, 20);
  ndn::FibHelper::AddRoute(node5, "/dst1", iGate2, 20);
  ndn::FibHelper::AddRoute(node1, "/src2", iGate1, 20);
  ndn::FibHelper::AddRoute(node1, "/iGate1", iGate1, 20);
  ndn::FibHelper::AddRoute(node2, "/iGate1", iGate1, 20);
  ndn::FibHelper::AddRoute(node2, "/src1", iGate1, 20);
  ndn::FibHelper::AddRoute(iGate1, "/src1", node1, 20);
  ndn::FibHelper::AddRoute(iGate1, "/src2", node2, 20);
  ...
  consumerHelper0.SetAttribute("Batches", StringValue("7s 2 10s 100"));
  //comsumer
  consumerHelper0.SetPrefix("/src2");
  //consumerHelper0.Install(node1);

  ndn::AppHelper consumerHelper1("ns3::ndn::ConsumerBatches");
  consumerHelper1.SetAttribute("Batches", StringValue("3s 15"));
  //comsumer
  consumerHelper1.SetPrefix("/dst3");
